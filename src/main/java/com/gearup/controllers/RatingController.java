...
//  Get Average Rating of a Garage
	@GetMapping("/averagerating/{garageId}")
	public ResponseEntity<?> getAveragerating(@PathVariable Long garageId) {

		return ResponseEntity.ok(ratingService.getAverageRatingForGarage(garageId));
	}
